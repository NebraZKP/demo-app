...
exports.allocateAggregatorFee = void 0;
const cmd_ts_1 = require("cmd-ts");
const options = __importStar(require("./options"));
const config = __importStar(require("./config"));
const ethers = __importStar(require("ethers"));
exports.allocateAggregatorFee = (0, cmd_ts_1.command)({
    ...
    description: "Allocate the aggregator fee in Saturn's fee model contract",
...
//# sourceMappingURL=allocateAggregatorFee.js.map